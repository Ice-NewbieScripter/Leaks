...
oldBtn.MouseButton1Click:Connect(function()
    runScript("https://raw.githubusercontent.com/secret-script/Leaks/main/wackshopr-tech%20old.lua")
end)

newBtn.MouseButton1Click:Connect(function()
    runScript("https://raw.githubusercontent.com/secret-script/Leaks/main/wackshopr-tech%20new.lua")
end)
